...
来源：[`packages/core/session/src/types.ts:435`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:443`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:466`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:497`](../packages/core/session/src/types.ts)
...
来源：[`packages/core/session/src/types.ts:431`](../packages/core/session/src/types.ts)
...
来源：[`packages/core/tools/src/types.ts:46`](../packages/core/tools/src/types.ts)
...
来源：[`packages/llm/llm/src/message.ts:185`](../packages/llm/llm/src/message.ts)
...
来源：[`packages/llm/llm/src/message.ts:122`](../packages/llm/llm/src/message.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `id` | 必需 | `string` |
| `role` | 必需 | [`union (2 variants)`](#persistence-type-sha256-36f8d9ef1c34851845307f0580382c14307b35ecb8fb85fb41b60cfa5a18a67c) |
| `source` | 必需 | `string` |
| `username` | 必需 | `string` |
...
来源：[`packages/core/session/src/types.ts:191`](../packages/core/session/src/types.ts) · [`packages/interaction/commands/src/types.ts:75`](../packages/interaction/commands/src/types.ts) · [`packages/interaction/commands/src/types.ts:79`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm/src/message.ts:111`](../packages/llm/llm/src/message.ts) · [`packages/session/session-title/src/types.ts:35`](../packages/session/session-title/src/types.ts)
...
来源：[`packages/llm/llm/src/message.ts:214`](../packages/llm/llm/src/message.ts)
...
来源：[`packages/llm/llm/src/message.ts:152`](../packages/llm/llm/src/message.ts)
...
[`Message`](#persistence-type-sha256-df67968dd8bba2c9b39b0df796c26929b34e299248b7d27d288a055f610a1d6c) 的数组。
...
来源：[`packages/core/tools/src/types.ts:23`](../packages/core/tools/src/types.ts)
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-7a3702533732ece60a5ddcb13bfc5e1d5061b8a059421191bac142f58c78c1e8) |
...
来源：[`packages/core/tools/src/index.ts:705`](../packages/core/tools/src/index.ts)
...
来源：[`packages/llm/llm/src/message.ts:191`](../packages/llm/llm/src/message.ts)
...
来源：[`packages/core/session/src/types.ts:197`](../packages/core/session/src/types.ts)
...
| `content` | 必需 | [`ContentBlock[]`](#persistence-type-sha256-b52f215a6cd691058a3413c12f161fa3b563a2f4895adb3df6f744ec4b0a6ef1) |
| `id` | 必需 | `string` |
| `principal` | 可选 | [`AuthenticatedPrincipal`](#persistence-type-sha256-2e57689d48b8b60f2c1ed269cd61f6c2cb012d86604e524e8b2df9eff376a320) |
| `role` | 必需 | `"user"` |
| `source` | 必需 | [`MessageSource`](#persistence-type-sha256-40e314bd88730b4bff04a2083cc540ef8659ee2240eeaae0132cac974784b945) |
...
[`UserMessage`](#persistence-type-sha256-3b4fefc4e7615cca5e127fea7d8e01f6f5e034d83bc975132e6791fd65751387) 的数组。
...
来源：[`packages/api/session-controller/src/types.ts:398`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:21`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:20`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:32`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:8`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/schedule/schedule/src/types.ts:12`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
...
来源：[`packages/core/session/src/types.ts:387`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:27`](../packages/core/tools/src/types.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-fd946b3680b64498ec7d89c0e36d2800b813e51391e6dffba3ebda6469d5f523) |
| `outcome` | 可选 | `"canceled"` |
...
来源：[`packages/core/session/src/types.ts:215`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:160`](../packages/llm/llm/src/types.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-2b31c29460683df9a53aab6a84b196b040c6e6fe677ffd90d114b8a21caee79d) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-9d9a3cbf8e2a3fcdcc1cad0847d14d65a55485a056fa38b1945d1fd424d9ca26) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ principal?, step, turn }`](#persistence-type-sha256-dc5e0e163ef6c361efe3dd70103f0023bcb0b0fe14a127b91a57f87bca171139) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"step/start"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`PtcDispatchEventData`](#persistence-type-sha256-b06049ae933b90f0bc495ec34336c70dcb95970f596cf6692c2f5311f972b76e) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`PtcDispatchStartEventData`](#persistence-type-sha256-2da1f7169ed1f1f9fd9eeefc12b74029350e283f083e0fc7c355a6316f20ae92) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ principal?, turn }`](#persistence-type-sha256-227f059f9b72c09d9b9b751fc63d8a4265d482a4fcfe53be815f21bbf373fab3) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"turn/start"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-3b4fefc4e7615cca5e127fea7d8e01f6f5e034d83bc975132e6791fd65751387) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
