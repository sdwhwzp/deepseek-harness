...
来源：[`packages/session-query/session-log-export/src/index.ts:49`](../packages/session-query/session-log-export/src/index.ts)
...
- `@deepseek-ai/dsh-principal-access` — 抽象 `PrincipalAccessService`（[`packages/identity/principal-access/src/index.ts`](../packages/identity/principal-access/src/index.ts)）
