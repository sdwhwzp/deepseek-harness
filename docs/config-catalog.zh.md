...
- `source`: [`packages/api/workspace-controller/src/index.ts:37`](../packages/api/workspace-controller/src/index.ts)
...
- `source`: [`packages/session-query/session-log-export/src/index.ts:53`](../packages/session-query/session-log-export/src/index.ts)
...
| `@deepseek-ai/dsh-client-ui-deliverables` | `systemPrompt` · `connection` · `sessionQuery` · `sessionController` · `typertGateway` · `workspaceFiles` · `fs` · `sandboxPolicy` · `workspaceChanges` | [`packages/client/ui-deliverables/src/index.ts`](../packages/client/ui-deliverables/src/index.ts) |
...
| `@deepseek-ai/dsh-goal-round-driver` | `agents` · `goals` · `sessions` · `sessionProjections` | [`packages/goal/goal-round-driver/src/index.ts`](../packages/goal/goal-round-driver/src/index.ts) |
