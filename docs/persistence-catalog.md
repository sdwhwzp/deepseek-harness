...
| `event:agent/inbox/spliced` | event | `04099928dfb41064f13b163f2a3a5aa2bd59369e4dcd679f13f3317bab4d53fd` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:step/start` | event | `e45e981c9edcdd8ac4a5ffa272c28ae489ddfe1c8e5b470aebd38d4c2fb5c30e` | [`event:step/start`](#persistence-type-eventstepstart) |
...
| `event:tool/ptc-dispatch` | event | `0441c8b328c191656598ddbf831c529979076453f24595557610839b2a004223` | [`event:tool/ptc-dispatch`](#persistence-type-eventtoolptc-dispatch) |
| `event:tool/ptc-dispatch-start` | event | `54f30a440e3764d81ad52bb0ea26c662195d96a1135e72c94a7506592e218774` | [`event:tool/ptc-dispatch-start`](#persistence-type-eventtoolptc-dispatch-start) |
...
| `event:turn/start` | event | `171a37e51ed002a77b9976094748fb961f573bfa5a65e5a17c0c645964a96a6d` | [`event:turn/start`](#persistence-type-eventturnstart) |
| `event:user/message` | event | `6cfa6375a1763421c2f18ba7a608aa79fbad51c258a68e6f1b9ee06e83e1fac6` | [`event:user/message`](#persistence-type-eventusermessage) |
...
SHA-256: `04099928dfb41064f13b163f2a3a5aa2bd59369e4dcd679f13f3317bab4d53fd`
...
SHA-256: `3d47f45f85e08d6ace9c11521d839b936f17a74969aa8a019e0053537465cee8`
...
SHA-256: `37d6759444518ddf28e3513b8bbcdff8ef08db5f504c8922c0f395a665ceacd8`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0principalrole"></a>

### `event:agent/inbox/spliced.data.inserted[0].principal.role`
...
Sources: [`packages/core/session/src/types.ts:190`](../packages/core/session/src/types.ts) · [`packages/interaction/commands/src/types.ts:75`](../packages/interaction/commands/src/types.ts) · [`packages/interaction/commands/src/types.ts:79`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm/src/message.ts:103`](../packages/llm/llm/src/message.ts) · [`packages/session/session-title/src/types.ts:35`](../packages/session/session-title/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:374`](../packages/core/session/src/types.ts)
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:step/start.data`](#persistence-type-eventstepstartdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"step/start"` |

<a id="persistence-type-eventstepstartdata"></a>

### `event:step/start.data`
...
| Property | Presence | Type |
|---|---|---|
| `principal` | optional | [`packages/llm/llm/src/message.ts#AuthenticatedPrincipal`](#persistence-type-packagesllmllmsrcmessagetsauthenticatedprincipal) |
| `step` | required | `number` |
| `turn` | required | `number` |
...
SHA-256: `0441c8b328c191656598ddbf831c529979076453f24595557610839b2a004223`
...
Sources: [`packages/core/session/src/types.ts:367`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:27`](../packages/core/tools/src/types.ts)
...
SHA-256: `6cfa6375a1763421c2f18ba7a608aa79fbad51c258a68e6f1b9ee06e83e1fac6`
...
Sources: [`packages/core/tools/src/index.ts:688`](../packages/core/tools/src/index.ts)
...
SHA-256: `89203a195e69a345a1315bf5fc278a1cfe084ee72c5801ba7ee4f1551c6a77f7`
...
### `packages/llm/llm/src/message.ts#AuthenticatedPrincipal`

SHA-256: `2e57689d48b8b60f2c1ed269cd61f6c2cb012d86604e524e8b2df9eff376a320`

Sources: [`packages/llm/llm/src/message.ts:114`](../packages/llm/llm/src/message.ts)

| Property | Presence | Type |
|---|---|---|
| `id` | required | `string` |
| `role` | required | [`event:agent/inbox/spliced.data.inserted[0].principal.role`](#persistence-type-eventagentinboxspliceddatainserted0principalrole) |
| `source` | required | `string` |
...
Sources: [`packages/llm/llm/src/message.ts:147`](../packages/llm/llm/src/message.ts)
...
Sources: [`packages/llm/llm/src/message.ts:144`](../packages/llm/llm/src/message.ts)
...
Sources: [`packages/llm/llm/src/message.ts:176`](../packages/llm/llm/src/message.ts)
...
Sources: [`packages/llm/llm/src/message.ts:182`](../packages/llm/llm/src/message.ts)
...
SHA-256: `d8294c3a9f9fa46638f84a87f0184c6c3561aa0b871f430246d950c25b09a23b`

Sources: [`packages/llm/llm/src/message.ts:159`](../packages/llm/llm/src/message.ts)
...
Sources: [`packages/core/session/src/types.ts:445`](../packages/core/session/src/types.ts)
...
Sources: [`packages/api/session-controller/src/types.ts:378`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:20`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:20`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:32`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:8`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/schedule/schedule/src/types.ts:10`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
