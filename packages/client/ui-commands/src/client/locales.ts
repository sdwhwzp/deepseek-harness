...
export const zh = {
  ...
  'description.image': '根据文字描述生成图片',
  'description.readImage': '读取并分析工作区图片',
...
export const en = {
  ...
  'description.image': 'Generate an image from a text prompt',
  'description.readImage': 'Read and analyze a workspace image',
