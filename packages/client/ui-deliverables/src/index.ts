...
/** Services required for file-reference guidance, change summaries, and authenticated native opens of declared or changed files. */
export const inject = ['systemPrompt', 'connection', 'sessionQuery', 'sessionController', 'typertGateway', 'workspaceFiles', 'fs', 'sandboxPolicy', 'workspaceChanges']
