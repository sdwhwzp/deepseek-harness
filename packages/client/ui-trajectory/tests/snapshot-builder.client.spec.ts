...
import { trajectoryToolKey } from '../src/client/trajectory-record.ts'
...
describe('TrajectorySnapshotBuilder', () => {
  ...
  it('indexes exact step headers and the active tool schema without backward scans', () => {
    ...
    expect(snapshot.callSchemas.get(trajectoryToolKey('call-edit', 7))).toEqual(exactPrompt.tools[0])
  })
