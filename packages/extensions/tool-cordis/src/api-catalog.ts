...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  {
    key: 'principalAccess',
    summary: 'Service Definition for deployment authorization.',
    description: 'Service Definition for deployment authorization. Providers validate the principal\'s source and subject against deployment-owned account data, then return only the requested resource ids that principal may read.',
    methods: [
      {
        signature: 'abstract resolve( principal: AuthenticatedPrincipal, subjects: PrincipalAccessSubjects, signal?: AbortSignal, ): Promise<PrincipalAccessResult>',
        description: 'Resolve the readable subset of one batched request.',
        parameters: [{ name: 'principal', description: 'Host-verified message-scoped identity.' }, { name: 'subjects', description: 'candidate Session and Workspace ids.' }, { name: 'signal', description: 'optional caller cancellation.' }],
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Read authorized Session rows without resuming an Agent or probing denied artifacts.',
      ...
      },
      {
        ...
        description: 'Select one authorized Session-local model after explicitly resuming the Session.',
      ...
      },
      {
        ...
        description: 'Open one path prepared by an authorized Session-aware caller on the Host desktop.',
        parameters: [{ name: 'request', description: 'owning Session and path after best-effort workspace resolution.' }, { name: 'signal', description: 'caller lifetime; abort terminates the native command.' }],
        returns: 'confirmation after the native opener accepts the path.',
        throws: ['RemoteError when the request is invalid, cancelled, or the opener fails.'],
      },
      {
        signature: '@Remote(\'rename\') async rename(request: SessionRenameRequest): Promise<SessionRenameValue>',
        description: 'Rename one authorized Session after explicitly resuming it.',
      ...
      },
      {
        ...
        description: 'Fork one authorized cold-readable completed-turn prefix into a new Session.',
      ...
      },
      {
        ...
        description: 'Admit one prompt after authorizing and explicitly resuming its Session.',
      ...
      },
      {
        ...
        description: 'Read one image proven reachable from an authorized Session log.',
      ...
      },
      {
        ...
        description: 'Mutate one still-pending queue occurrence on an authorized live Agent.',
      ...
      },
      {
        ...
        description: 'Cancel one authorized active Agent turn without dropping its pending inbox.',
  ...
  },
  {
    ...
    methods: [
      {
        signature: '@Remote async list( sessionId: SessionId, query: string, signal: AbortSignal, ): Promise<FileReferenceCandidate[]>',
        description: 'List file and directory candidates for one authorized Agent\'s working directory.',
        parameters: [{ name: 'sessionId', description: 'target Session authorized before its Agent is resolved or resumed.' }, { name: 'query', description: 'path text following `@` or `@"`.' }, { name: 'signal', description: 'caller cancellation.' }],
    ...
    methods: [
      {
        ...
        description: 'List the user-invocable skills visible to one authorized Session composition.',
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Deliver one browser-authored message to a continuable child through the exact live direct parent, retaining the caller-minted request identity and validated browser zone on the accepted message. The transport-verified caller is snapshotted from the active Gateway invocation. Success identifies the message the child\'s FIFO inbox accepted; later execution is independent of this call. Image parts are admitted and persisted through the attachment store before delivery, and the child\'s model must accept image input.',
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Return the transport-verified principal for the active Remote call.',
        parameters: [],
