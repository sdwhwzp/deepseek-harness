...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:109',
  },
  {
  ...
  },
  {
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.input.bootstrap\', () => ctx.slots.register(\n      { name: \'conversation.input.bootstrap\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  {
    key: 'sidebar.workspaces.action',
    kind: 'list',
    scope: 'root',
    summary: 'Ordered actions rendered above the sidebar Workspace header.',
    doc: 'Ordered actions rendered above the sidebar Workspace header.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.action\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.action\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:107',
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:111',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:158',
  },
  {
  ...
  {
    key: 'tool.call.result-images',
    kind: 'single',
    scope: 'session',
    summary: 'Result images outside the read_image card, including generic tools and historical image reads without card metadata.',
    doc: 'Result images outside the read_image card, including generic tools and\nhistorical image reads without card metadata. The call tree owns this\ngallery so root and nested results use the same authorized loader.',
    registerOptions: [],
    ownerProps: [
      '/** Owner currency of the Tool image gallery slot: references plus the loader. */\nexport interface ToolImagesOwnerProps {\n  /** Durable references or submission-echo previews in result order. */\n  images: readonly MessageImageSource[]\n  /** Session-authorized image URL loader for the durable arm. */\n  loadImage: MessageImageLoader\n  /** Horizontal placement inside the owning record. */\n  align: \'start\' | \'end\'\n}',
    ],
    ...
    source: 'packages/client/ui-tool/src/client/contract/slots.ts:51',
  },
  {
