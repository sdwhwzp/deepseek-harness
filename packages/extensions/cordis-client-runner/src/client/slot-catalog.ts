...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Deployment controls staged beside the blank-session Hero selectors.',
    doc: 'Deployment controls staged beside the blank-session Hero selectors.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    source: 'packages/client/ui-trajectory/src/client/trajectory-contract.ts:114',
  },
  {
