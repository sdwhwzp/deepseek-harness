...
export class ApiSessionList {
   ...
   * @param resolveReadable - optional caller-owned authorization applied before summaries or cold probes.
   ...
   * @param resolveReadable - optional caller-owned authorization over list-visible ids.
