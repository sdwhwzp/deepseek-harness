...
export interface TestSessionRemote {
  workspacePathApplications(
    request: { readonly sessionId: SessionId; readonly path: string }, signal?: AbortSignal,
...
/** Image defaults exposed by the fixture controller. */
export const TEST_IMAGE_LIMITS: ImageAttachmentLimits = Object.freeze({
...
function installControllers(
  ...
  if (defaults.omitAttachments !== true && ctx.get('attachments') === undefined) {
