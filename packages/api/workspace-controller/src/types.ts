...
/** One durable Workspace projected with caller-readable Session membership. */
...
/** Newly created or caller-readable previously registered Workspace. */
...
/** Workspace mutation returning the changed row with readable Session membership. */
...
/** Caller-readable Workspace registry order after a mutation. */
...
/** Caller-readable archived Session set after a mutation. */
export interface WorkspaceArchiveValue {
  readonly archivedSessionIds: readonly SessionId[]
}

/** Complete caller-readable reconnect baseline for Workspace browser state. */
