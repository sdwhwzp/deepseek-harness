...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  requestPrincipal: 'web-server.md',
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  'conversation/prepare-send': 'client-side prompt preparation — packages/client/ui-conversation/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ConnectionPrincipalRequest: 'deployment authentication input is owned by packages/client/connection/src/rpc.ts',
  ConnectionRequestAuthorization: 'request authorization outcome is owned by packages/client/connection/src/rpc.ts',
